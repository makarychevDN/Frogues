...
{
    public class IncreaceStrengthForMissingHealthPassiveAbility : PassiveAbility, IAbleToHaveDelta
    {
        //[SerializeField] private StatEffectTypes statEffectType; //todo fix this
